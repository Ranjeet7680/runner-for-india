...
# Paths to generated AI images
img_dir = r"C:\Users\Victus\.gemini\antigravity\brain\01de55fc-531f-45b1-963e-6ed7d559612a"

def get_base64_image(filename):
    for f in os.listdir(img_dir):
        if f.startswith(filename) and f.endswith(".jpg"):
...
cover_img = get_base64_image("ebook_cover_art")
trains_img = get_base64_image("cyberpunk_metro_trains")
characters_img = get_base64_image("runner_characters_lineup")
hud_img = get_base64_image("neural_ai_hud")

html_head = f"""<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>NEXORA METRO RUNNER — 60-Page Engineering Architecture & Game Design eBook</title>
<style>
  @import url('https://fonts.googleapis.com/css2?family=Rajdhani:wght@500;600;700;800&family=Space+Grotesk:wght@400;500;600;700&family=Fira+Code:wght@400;500;600&display=swap');

  @page {{
    size: A4;
    margin: 18mm 14mm 18mm 14mm;
    @top-right {{
      content: "NEXORA METRO RUNNER V2.0 • ARCHITECTURE & ENGINEERING MANUAL";
...
<div class="cover-page">
  <div class="cover-header">
    <span class="cover-badge">OFFICIAL TECHNICAL ARCHITECTURE MANUAL</span>
    <div class="cover-title">NEXORA METRO RUNNER</div>
    <div class="cover-subtitle">Engineering a Next-Generation 3D WebGL Game Engine, Neural AI Director & Procedural Ecosystem</div>
  </div>

  <div class="cover-img-container">
    <img src="{cover_img}" class="cover-img" alt="Nexora Metro Runner Cinematic 3D Cover Art">
  </div>
  ...
  <div class="cover-metadata">
    ...
    <div class="meta-row"><span class="meta-lbl">DOCUMENT SPECIFICATION:</span><span class="meta-val">Full 60-Page Technical Architecture & System GDD</span></div>
    ...
    <div class="meta-row"><span class="meta-lbl">PUBLICATION DATE:</span><span class="meta-val">August 2026 • Enterprise Architecture Release</span></div>
  </div>
</div>
...
<div class="toc-page">
  ...
  <table style="font-size: 9.5pt;">
    ...
    <tr><td><b>Chapter 01</b></td><td>Executive Summary & Visionary Mission Statement</td><td>Overview</td></tr>
    <tr><td><b>Chapter 02</b></td><td>Market Landscape & Competitive Differentiation (vs Subway Surfers, Temple Run)</td><td>Market Analysis</td></tr>
    <tr><td><b>Chapter 03</b></td><td>Problem Space Analysis & Strategic Solution Architecture</td><td>Problem/Solution</td></tr>
    <tr><td><b>Chapter 04</b></td><td>The 6 Pillars of Unique Selling Propositions (USP)</td><td>Product Strategy</td></tr>
    <tr><td><b>Chapter 05</b></td><td>Game Design Document (GDD) & Kinematic Physics Simulation</td><td>Game Physics</td></tr>
    <tr><td><b>Chapter 06</b></td><td>3D Entity Engineering: 7 Playable Avatars & Custom Face Mapping</td><td>Graphics & UVs</td></tr>
    <tr><td><b>Chapter 07</b></td><td>Procedural Railway Simulation: Multi-Coach Rakes & Wedge Ramps</td><td>World Engine</td></tr>
    <tr><td><b>Chapter 08</b></td><td>Hazard Systems, AABB Collision Detection & Screen Trauma Physics</td><td>Collisions</td></tr>
    <tr><td><b>Chapter 09</b></td><td>Power-Up Matrix & Active Hero Overdrive Simulation</td><td>Mechanics</td></tr>
...
# Dictionary of chapter images
chapter_images = {
    "CHAPTER 06": (characters_img, "Figure 6.1 — 3D Character Lineup: Arun (Boy), Kira (Girl), Unit-7 (Titanium Droid), and Vikram Singh (CID Detective)"),
    "CHAPTER 07": (trains_img, "Figure 7.1 — Procedural Indian Multi-Coach Metro Rakes with Aerodynamic Wedge Climbing Ramps & Catenary Gantries"),
    "CHAPTER 13": (hud_img, "Figure 13.1 — Neural Adaptive AI Game Director Real-Time Cognitive Load HUD & Speedometer Telemetry")
}

chapters_data = [
    ("CHAPTER 01", "Executive Summary & Visionary Mission Statement", """
    <h2>1.1 Project Overview</h2>
    <p><b>NEXORA METRO RUNNER</b> is an ultra-high-performance, next-generation 3D WebGL endless-runner game engine designed and developed by the <b>Nexora Team</b>. Operating under the core motto <i>"Zero-Download, Universal Accessibility, Culturally Resonant"</i>, the platform redefines casual mobile gaming by delivering console-grade 3D graphics, adaptive cognitive difficulty scaling, and procedural synthesized audio directly within standard mobile and desktop web browsers.</p>
...
this.skillIndex = (reactionScore * 0.4) + (nearMissBonus * 0.3) + (coinEfficiency * 0.3);
    ...
    <div style="margin-top: 30px; border-top: 2px solid #cbd5e0; padding-top: 14px; text-align: center; color: #718096; font-size: 8.5pt;">
...
for chap_num, title, body in chapters_data:
    img_block = ""
    if chap_num in chapter_images:
        src, caption = chapter_images[chap_num]
        if src:
            img_block = f"""
    ...
    chap_str = chapter_expansion_template.replace("__CHAP_NUM__", chap_num).replace("__TITLE__", title).replace("__BODY__", body).replace("__IMG_BLOCK__", img_block)
    full_html += chap_str
...
print("Compiling Rich PDF with AI Images & Full-Filled Pages via Edge Headless...")
res = subprocess.run(cmd, capture_output=True, text=True)
print("Return code:", res.returncode)

if os.path.exists(pdf_file):
    size_mb = os.path.getsize(pdf_file) / (1024 * 1024)
    print(f"Rich PDF generated successfully: {pdf_file} ({size_mb:.2f} MB)")
else:
